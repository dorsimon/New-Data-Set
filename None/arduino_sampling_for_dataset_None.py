...
#        np.savetxt(f_handle,row_arr)
    ...
    np.savetxt('/Users/dorsimon/Desktop/machine learning project/New Data Set/None/Samples/None_' + str(datetime.datetime.now().strftime('%d%mU%H%M%S')) + '.txt', row_arr) #save data in file (load w/np.loadtxt())
